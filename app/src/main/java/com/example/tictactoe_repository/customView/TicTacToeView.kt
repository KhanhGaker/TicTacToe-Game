package com.example.tictactoe_repository.customView
...
import com.example.tictactoe_repository.R
...
class TicTacToeView : View, ValueAnimator.AnimatorUpdateListener {
    ...
    private fun init() {
        ...
        highLightPaint.color = ContextCompat.getColor(context, R.color.colorPrimary)
